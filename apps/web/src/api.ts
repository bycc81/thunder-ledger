...
export type Sale = { id: string; productId: string; productName: string; quantity: number; totalPrice: string; consumedCost: string; sellerUserId: string; sellerUsername: string; occurredAt: string; note: string | null; createdAt: string; reversalReason: string | null; reversedAt: string | null; settled: boolean };
...
export type SettlementSale = { id: string; productId: string; productName: string; quantity: number; totalPrice: string; consumedCost: string; sellerUserId: string; sellerUsername: string; occurredAt: string };
...
export type SettlementPreview = { saleTotal: string; expenseTotal: string; costTotal: string; profitTotal: string; isLoss: boolean; members: SettlementResultMember[]; transfers: Array<{ payerUserId: string; payerUsername: string; payeeUserId: string; payeeUsername: string; amount: string }> };
