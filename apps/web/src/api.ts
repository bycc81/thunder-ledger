...
export type ProductGroupTemplate = { id: string; name: string; createdAt: string; updatedAt: string; variants: Array<{ id: string; name: string; position: number }> };
...
export type Sale = { id: string; productId: string; productName: string; productGroupName?: string | null; variantName?: string | null; displayName?: string; quantity: number; totalPrice: string; consumedCost: string; salesChannel: string | null; feeMode: 'percentage' | 'amount' | null; feeRate: number | null; serviceFee: string; receivedAmount: string; sellerUserId: string; sellerUsername: string; occurredAt: string; note: string | null; createdAt: string; reversalReason: string | null; reversedAt: string | null; settled: boolean };
export type SaleDetail = Sale & { grossProfit: string; expenses: Array<{ id: string; name: string; amount: string; payerUserId: string; payerUsername: string; occurredAt: string; reversalReason: string | null; reversedAt: string | null }>; settlement: { id: string; confirmedAt: string } | null };
...
export type SettlementSale = { id: string; productId?: string; productName: string; productGroupName?: string | null; variantName?: string | null; displayName?: string; quantity: number; totalPrice: string; consumedCost: string; serviceFee: string; sellerUserId?: string; sellerUsername: string; occurredAt: string };
