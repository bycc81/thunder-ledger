    ...
    <main v-else-if="product" class="content">
      ...
      <section class="image-section" data-ai-id="product-detail-images">
        ...
        <template v-else>
          ...
          <div class="carousel-controls"><van-button class="tl-button--secondary" plain :disabled="imageIndex === 0" data-ai-id="product-image-carousel-previous" @click="previous">上一张</van-button><strong data-ai-id="product-image-carousel-index">第 {{ imageIndex + 1 }} / {{ product.images.length }} 张</strong><van-button class="tl-button--secondary" plain :disabled="imageIndex === product.images.length - 1" data-ai-id="product-image-carousel-next" @click="next">下一张</van-button></div>
        </template>
      </section>
